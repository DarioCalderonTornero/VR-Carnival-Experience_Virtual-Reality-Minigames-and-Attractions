...
public class BallonFinalScore : MonoBehaviour
{
    ...
    private void Update()
    {
        finalScoreText.text = "Ballons Poped: " + Ballon_Score.Instance.GetScore().ToString();
        bestScoreText.text = "Best Score: " + Ballon_Score.Instance.GetBestScore().ToString();
    }
